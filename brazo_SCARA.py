...
def generar_perfil_cubico(q_ini, q_fin, t_total, dt):
    ...
    for i in range(num_joints): 
        ...
        q_t = q0 + a2 * time_vector**2 + a3 * time_vector**3
...
def main():
    ...
    q_home = [0, 0, 0.0]
    q_pre_pick = [math.radians(45), math.radians(30), 0.0]  
    q_pick     = [math.radians(45), math.radians(30), 0.15] 
    q_pre_place = [math.radians(-45), math.radians(-30), 0.0] 
    q_place     = [math.radians(-45), math.radians(-30), 0.15] 
